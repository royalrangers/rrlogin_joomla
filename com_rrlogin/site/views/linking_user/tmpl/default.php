...
<div class="login">
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_rrlogin&task=join_mail'); ?>" method="post">
        <fieldset>
            ...
            <div class="rrlogin-buttons-linking">
                ...
                <div>
                    <input type="button" class="button"
                           onclick="document.location.href='<?php echo JRoute::_('index.php?option=com_rrlogin&task=recallpass'); ?>'"
                           value="<?php echo JText::_('COM_SLOGIN_LOST_PASS_LOGIN'); ?>"/>
                </div>
                <div>
                    <input type="button" class="button"
                           onclick="document.rrlogin_logout_form.submit();"
            ...
            <input type="hidden" name="rrlogin_id" value="<?php echo $this->rrlogin_id; ?>"/>
...
<form action="<?php echo JRoute::_('index.php'); ?>"
      method="post" id="rrlogin_logout_form" name="rrlogin_logout_form">
