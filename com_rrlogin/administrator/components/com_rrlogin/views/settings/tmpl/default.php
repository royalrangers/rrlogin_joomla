...
<script type="text/javascript">
    Joomla.submitbutton = function(task) {
        if (task == 'repair' || task == 'clean') {
            if (confirm("<?php echo JText::_('COM_RRLOGIN_CONFIRM'); ?>")){
...
<div class="span12">
    <div class="row">
        <div class="span7">
             <h2 class="text-center"><?php echo JText::_('COM_RRLOGIN_USER_STRUCTURE'); ?></h2>
            <div id="pie_chartdiv" style="width:100%; height:350px;"></div>
        </div>
        <div class="span5">
            <h2>Royal Ranger Network Login</h2>
            <p><?php echo JText::_('COM_RRLOGIN_XML_DESCRIPTION'); ?></p>
          
            <div>
            
                <?php echo JText::_('COM_RRLOGIN_HELP'); ?>
            </div>
            <p></p>
            <?php echo JText::_('COM_RRLOGIN_DONITE'); ?>

            <form
                action="<?php echo JRoute::_('index.php?option=com_rrlogin'); ?>"
                method="post"
                name="adminForm"
                id="adminForm"
                >
	...
	<?php if($this->config->get('service_auth', 0) == 0){ ?>
		...
		<div class="<?php echo $class; ?>">
            <h2><?php echo JText::_('COM_RRLOGIN_AUTH_PLUGINS'); ?></h2>
            <table class="table">
                <thead>
                <tr>
                    <th>#</th>
                    <th><?php echo JText::_('COM_RRLOGIN_PLUGIN_NAME'); ?></th>
                    <th><?php echo JText::_('COM_RRLOGIN_PLUGIN_PUBLISHED'); ?></th>
                    <th><?php echo JText::_('COM_RRLOGIN_PLUGIN_SET'); ?></th>
                </tr>
                </thead>
                <tbody>
	...
	<?php } ?>
		...
		<div class="<?php echo $class; ?>">
            <h2><?php echo JText::_('COM_RRLOGIN_INTEGRATION_PLUGINS'); ?></h2>
            <table class="table">
                <thead>
                <tr>
                    <th>#</th>
                    <th><?php echo JText::_('COM_RRLOGIN_PLUGIN_NAME'); ?></th>
                    <th><?php echo JText::_('COM_RRLOGIN_PLUGIN_PUBLISHED'); ?></th>
                    <th><?php echo JText::_('COM_RRLOGIN_PLUGIN_INSTALLED'); ?></th>
                </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a target="_blank" href="<?php echo $plugin->link; ?>">
                                <?php echo JText::_('COM_RRLOGIN_PLUGIN_BUY'); ?>
                            </a>
                        </td>
                    </tr>
                    <?php $i++; endforeach; ?>
