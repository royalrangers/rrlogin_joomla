 ...
 * @since		1.6
 */
class rrloginModelSettings  extends JModelList
{
    ...
    {
        $plugins = $this->getPlugins('rrlogin_auth');
        return $plugins;
    }

    public function getIntegrationPlugins()
    {
        $plugins = $this->getPlugins('rrlogin_integration');
        return $plugins;
    }
    ...
    public function getComPlugins()
    {
        ...
        if(JFolder::exists(JPATH_ROOT.'/components/com_comprofiler'))
        {
            ...
            $plg->link = 'http://argens.ru/avtorizatsiya-social-login/23-plagin-integratsii-rrlogin-community-builder';
            $plugins[] = $plg;
        }
        ...
        if(JFolder::exists(JPATH_ROOT.'/components/com_jomsocial'))
        {
            ...
            $plg->link = 'http://argens.ru/avtorizatsiya-social-login/24-plagin-integratsii-rrlogin-joomsocial';
            $plugins[] = $plg;
        }
        ...
        if(JFolder::exists(JPATH_ROOT.'/components/com_k2'))
        {
            ...
            $plg->element = 'k2';
            $plg->link = 'http://argens.ru/avtorizatsiya-social-login/21-plagin-integratsii-rrlogin-k2';
            $plugins[] = $plg;
        }
        ...
        if(JFolder::exists(JPATH_ROOT.'/components/com_kunena'))
        {
            ...
            $plg->element = 'kunena';
            $plg->link = 'http://argens.ru/avtorizatsiya-social-login/38-plagin-integratsii-rrlogin-kunena';
            $plugins[] = $plg;
        }
